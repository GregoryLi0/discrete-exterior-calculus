...
// Color maps
std::vector<std::pair<double, CPoint>> HOT = { {0.0, {0.0416, 0.0, 0.0}},
...
std::vector<std::pair<double, CPoint>> SEISMIC = {
...
std::vector<std::pair<double, CPoint>> COOLWARM = {
 ...
 */
CPoint mapToColor(double x, double min, double max, const std::string& colormap_name) {
    ...
    std::vector<std::pair<double, CPoint>> colormap;
    ...
    CPoint c1 = colormap[v1].second;
    CPoint c2 = colormap[v2].second;

    // Interpolate between the two colors.
    CPoint c = c1 + (c2 - c1) * (x - colormap[v1].first) / (colormap[v2].first - colormap[v1].first);
    CPoint color = { c[0], c[1], c[2] };
    return color;
}
 ...
 */
CPoint hsv(double h, double s, double v) {
